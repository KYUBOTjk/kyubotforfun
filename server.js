...
setInterval(() => {
  http.get(`http://systemyz.glitch.me/`);
}, 280000);
...
client.on('message', msg => {  
    if (msg.content === 'هلا') {  
      msg.reply('**هلا والله كيفك ؟ :smiling_face_with_3_hearts:**');  
    }
  });
...
client.on('message', msg => {  
    if (msg.content === 'كل خرا') {  
      msg.reply('** ما ناكلك :middle_finger:**');  
    }
  });
  ...
  client.on('message', msg => {  
    if (msg.content === 'احبك') {  
      msg.reply('**حبك برص يا سافل :poop:**');  
    }
  });


client.on('message', msg => {  
    if (msg.content === 'ايش اسمك') {  
      msg.reply('**تبغاني اقول اسم امك؟ :joy:**');  
    }
  });
   ...
   client.on('message', msg => {  
    if (msg.content === 'يو') {  
      msg.reply('**يو يو يو يو:joy: **');  
    }
  });

client.on('message', msg => {  
    if (msg.content === 'انا') {  
      msg.reply('**تفو يب انت**');  
    }
  });
...
client.on('message',async message => {
  ...
  if(message.content.startsWith(prefix + "تقديمانمي")) {
 
if(!message.channel.guild) return message.reply(' ');
 
 
  let submite = message.guild.channels.find(`name`, "↤−تقديم-انمي−↦");
    ...
    .then(collected => {
      ...
      msg.edit('📜 **| هل ستحترم القوانين؟... ✏ **').then(msg => {
          ...
          .then(collected => {
            ...
            msg.edit('🤵 **| ما هو افضل انمي بالنسبة لك ؟... ✏ **').then(msg => {
...
client.on('message',async message => {
  ...
  if(message.content.startsWith(prefix + "تقديمكيبوب")) {
 
if(!message.channel.guild) return message.reply(' ');
 
 
  let submite = message.guild.channels.find(`name`, "↤−تقديم-كيبوب−↦");
    ...
    .then(collected => {
      ...
      msg.edit('📜 **| هل ستحترم القوانين؟... ✏ **').then(msg => {
          ...
          .then(collected => {
            ...
            msg.edit('🤵 **| من هي افضل فرقة بالنسبة لك ؟... ✏ **').then(msg => {
...
client.on('message', message => {
    if (message.content == "-انمي"){
        var x = ["السؤال:من هي اكثر شخصية منحرفة بالانمي ؟",  
                 "السؤال:من هو رمز الثعلب في انمي الخاطيا السبع المميته ؟",
                 "السؤال:ما هو اسم عائلة ليفاي من انمي الهجوم على العمالقة ؟",
        ...
        var x3 = Math.floor(Math.random()*x.length)
        message.channel.send(` اول شخص يجب على سوال الانمي :  __**${x[x3]}**__
لديك 20 ثانية لكتابة الجواب الصحيح`).then(msg1=> {
            var r = message.channel.awaitMessages(msg => msg.content == x2[x3], {
                maxMatches : 1,
                time : 20000,
                errors : ['time']
        ...
        r.then((collected)=> {
            message.channel.send(`${collected.first().author}لقد قمت بكتابة الجواب الصحيح في الوقت المناسب  `);
        })
        })
    }
})
...
client.login('NzMyNTExNTI2MTExNjc0Mzc4.Xw1qhQ.toOrdw9zhcmMp_8McIQBK-2mLVM');
